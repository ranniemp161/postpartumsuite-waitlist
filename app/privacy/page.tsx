    ...
    <>
      <div className="card-raised policy">
        ...
        <p className="policy-lead">
          This page covers one thing: the waitlist form on this site. There are
          no accounts, no bookings and no payments here.
        </p>
        ...
        <h2>Who we are</h2>
        <p>
          {SITE_NAME} is the data controller for the details you give us on this
        ...
        <p>
          We do not use analytics or advertising cookies, and the fonts on this
          site are served from our own domain, so visiting this page does not
          hand your details to anyone else.
        </p>
        ...
        <p>
          ...
          protection. We rely on your explicit consent for all of it. The box on
          the form is never pre-ticked, and we record the moment you tick it.
        </p>

        <h2>What we use it for</h2>
        <p>
          To contact you about postpartum care becoming available in your area,
          and to work out where demand is concentrated so we can decide where to
          open next. We do not sell it, and we do not use it to advertise to
          you.
        </p>

        <h2>Where it is kept</h2>
        <p>
          Your details are written to a private Google Sheet that only our team
          can open. Nobody outside the team is given access to it.
        </p>

        <h2>How long we keep it</h2>
        <p>
          Until we have opened in your area and been in touch, or until you ask
          us to remove you, whichever comes first. If you ask, we delete your
          row.
        </p>
        ...
        <p>
          If you think we have handled your information badly, you can complain
